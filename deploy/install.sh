...
for file in index.html styles.css v22-layout.css smart-parser.js docx-schedule-parser.js app.js manifest.webmanifest icon.svg service-worker.js reset-password.js server.js outlook-sync.js google-sync.js package.json; do
